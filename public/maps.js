...
window.addEventListener('DOMContentLoaded', function () {
  ...
  for (var i = 0; i < container.length; i++) {
    var el, src, signature, tilesize, resolution, xtiles, ytiles, missing;
    _loop();
  }
});
